...
(function(){
  ...
  function bind(){
    document.getElementById('d4ChartRange')?.addEventListener('change',renderChart);document.getElementById('d4TransactionSearch')?.addEventListener('input',renderTransactions);document.getElementById('d4TransactionFilter')?.addEventListener('change',renderTransactions);
